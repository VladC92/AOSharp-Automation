    ...
    class EngiCombatHandler : GenericCombatHandler
    {
        ...
        public EngiCombatHandler()
        {
           ...
           // RegisterPerkProcessor(PerkHash.LegShot, DamagePerk);
            ...
            RegisterSpellProcessor(RelevantNanos.SympatheticEntropyInfusion, GenericBuff);
            RegisterSpellProcessor(RelevantNanos.CompositeMartialProwessExpertise, GenericBuff);
            RegisterSpellProcessor(RelevantNanos.CompositeSpecialistTradeskills, GenericBuff);
            RegisterSpellProcessor(RelevantNanos.PlasmaShield, GenericBuff);
            ...
            //RegisterSpellProcessor(RelevantNanos.GiftOfAssurance, EngiTeamBuff);
        ...
        public bool EngiTeamBuff(Spell spell, SimpleChar fightingTarget, ref (SimpleChar Target, bool ShouldSetTarget) actionTarget)
        {
        ...
        private static class RelevantNanos
        {
            ...
            public const int SympatheticEntropyInfusion = 154560;
            public const int CompositeMartialProwessExpertise = 302158;
            public const int CompositeSpecialistTradeskills = 273346;
            public const int PlasmaShield = 29774;
            public const int BoostedTendons = 269463;
            public const int GiftOfAssurance = 227680;
